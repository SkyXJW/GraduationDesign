...
RESULTS_FILE = "/home/xjg/GraduationDesign/results/Qwen_experiments_base.json"
...
def main():
    ...
    for category, dataset in test_data.items():
        ...
        for row in tqdm(dataset, desc=f"Processing {category}"):
            ...
            # print(base_prompt.format(problem))
            inputs = tokenizer(base_prompt.format(problem),return_tensors="pt")
